...
def predict_sequences_multiple(model, data, window_size, prediction_len):
    ...
    for i in range(2):
        ...
        predicted = []
        for j in range(5):
            a = curr_frame[newaxis,:,:]
            #print("curr_frame",a.shape)
...
X_train, y_train, X_test, y_test = load_data('data.csv', seq_len, True)
...
predictions = predict_sequences_multiple(model, X_test[:100], seq_len, 50)