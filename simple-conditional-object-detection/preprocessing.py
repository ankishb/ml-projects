                ...
                iaa.SomeOf((0, 5),
                    [
                        iaa.OneOf([
                            ...
                            iaa.MedianBlur(k=(3, 11)), # blur image using local medians
                        ]),
                        ...
                        iaa.Add((-10, 10), per_channel=0.5), # change brightness
            ...
            for obj in all_objs:
                if obj['xmax'] > obj['xmin'] and obj['ymax'] > obj['ymin'] 
                    ...
                    if grid_x < self.config['GRID_W'] and grid_y < self.config['GRID_H']:
                        ...
                        center_w = center_w / self.config['GRID_W'])
                        center_h = (obj['ymax'] - obj['ymin']) / (float(self.config['IMAGE_H']) 
                        center_h = center_h / self.config['GRID_H'])
